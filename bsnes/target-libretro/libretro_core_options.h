...
struct retro_core_option_definition option_defs_us[] = {
   ...
   {
      "bsnes_twofived_enable",
      "PPU 2.5D - Depth Buffer",
      "Enables the experimental 2.5D depth buffer used by the bsnes-hd renderer.",
      {
         { "ON",  "enabled"  },
         { "OFF", "disabled" },
         { NULL, NULL },
   ...
   {
      "bsnes_twofived_override_priority",
      "PPU 2.5D - Override SNES Priority",
      "Forces the 2.5D depth pipeline to ignore the SNES priority bits and rely only on the configured depth equations.",
      {
         { "ON",  "enabled"  },
         { "OFF", "disabled" },
         { NULL, NULL },
   ...
   {
      "bsnes_twofived_clamp_depth",
      "PPU 2.5D - Clamp Depth",
      "Limits computed 2.5D depth values to the 16-bit range so older shaders or tools expecting 16-bit depth continue to work.",
      {
         { "ON",  "enabled"  },
         { "OFF", "disabled" },
         { NULL, NULL },
   ...
   {
      "bsnes_twofived_far_depth",
      "PPU 2.5D - Far Plane Depth",
      "Sets the fallback depth value that is written whenever no layer contributes a pixel to the 2.5D buffer.",
      {
         { "65535", NULL },
         { "57344", NULL },
         { "49152", NULL },
   ...
   {
      "bsnes_twofived_bg1_base",
      "PPU 2.5D - BG1 Base Depth",
      "Sets the base depth offset used for BG1 when 2.5D rendering is enabled.",
      {
         { "0",     NULL },
         { "1024", NULL },
         { "2048", NULL },
   ...
   {
      "bsnes_twofived_bg1_palette",
      "PPU 2.5D - BG1 Palette Scale",
      "Scales the palette index contribution to BG1 depth results.",
      {
         { "0",   NULL },
         { "1",   NULL },
         { "2",   NULL },
   ...
   {
      "bsnes_twofived_bg1_priority",
      "PPU 2.5D - BG1 Priority Scale",
      "Scales the priority bits contribution to BG1 depth results.",
      {
         { "0",   NULL },
         { "4",   NULL },
         { "8",   NULL },
   ...
   {
      "bsnes_twofived_bg2_base",
      "PPU 2.5D - BG2 Base Depth",
      "Sets the base depth offset used for BG2 when 2.5D rendering is enabled.",
      {
         { "0",     NULL },
         { "1024", NULL },
         { "2048", NULL },
   ...
   {
      "bsnes_twofived_bg2_palette",
      "PPU 2.5D - BG2 Palette Scale",
      "Scales the palette index contribution to BG2 depth results.",
      {
         { "0",   NULL },
         { "1",   NULL },
         { "2",   NULL },
   ...
   {
      "bsnes_twofived_bg2_priority",
      "PPU 2.5D - BG2 Priority Scale",
      "Scales the priority bits contribution to BG2 depth results.",
      {
         { "0",   NULL },
         { "4",   NULL },
         { "8",   NULL },
   ...
   {
      "bsnes_twofived_bg3_base",
      "PPU 2.5D - BG3 Base Depth",
      "Sets the base depth offset used for BG3 when 2.5D rendering is enabled.",
      {
         { "0",     NULL },
         { "1024", NULL },
         { "2048", NULL },
   ...
   {
      "bsnes_twofived_bg3_palette",
      "PPU 2.5D - BG3 Palette Scale",
      "Scales the palette index contribution to BG3 depth results.",
      {
         { "0",   NULL },
         { "1",   NULL },
         { "2",   NULL },
   ...
   {
      "bsnes_twofived_bg3_priority",
      "PPU 2.5D - BG3 Priority Scale",
      "Scales the priority bits contribution to BG3 depth results.",
      {
         { "0",   NULL },
         { "4",   NULL },
         { "8",   NULL },
   ...
   {
      "bsnes_twofived_bg4_base",
      "PPU 2.5D - BG4 Base Depth",
      "Sets the base depth offset used for BG4 when 2.5D rendering is enabled.",
      {
         { "0",     NULL },
         { "1024", NULL },
         { "2048", NULL },
   ...
   {
      "bsnes_twofived_bg4_palette",
      "PPU 2.5D - BG4 Palette Scale",
      "Scales the palette index contribution to BG4 depth results.",
      {
         { "0",   NULL },
         { "1",   NULL },
         { "2",   NULL },
   ...
   {
      "bsnes_twofived_bg4_priority",
      "PPU 2.5D - BG4 Priority Scale",
      "Scales the priority bits contribution to BG4 depth results.",
      {
         { "0",   NULL },
         { "4",   NULL },
         { "8",   NULL },
   ...
   {
      "bsnes_twofived_obj_base",
      "PPU 2.5D - OBJ Base Depth",
      "Sets the base depth offset used for sprites when 2.5D rendering is enabled.",
      {
         { "0",     NULL },
         { "1024", NULL },
         { "2048", NULL },
   ...
   {
      "bsnes_twofived_obj_palette",
      "PPU 2.5D - OBJ Palette Scale",
      "Scales the palette index contribution to sprite depth results.",
      {
         { "0",   NULL },
         { "1",   NULL },
         { "2",   NULL },
   ...
   {
      "bsnes_twofived_obj_priority",
      "PPU 2.5D - OBJ Priority Scale",
      "Scales the priority bits contribution to sprite depth results.",
      {
         { "0",   NULL },
         { "4",   NULL },
         { "8",   NULL },
